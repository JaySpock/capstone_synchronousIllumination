...
module nios_setup_mm_interconnect_0 (
		...
		input  wire [15:0] nios2e_data_master_address,               //                 nios2e_data_master.address
		...
		input  wire [15:0] nios2e_instruction_master_address,        //          nios2e_instruction_master.address
	...
	wire  [15:0] nios2e_data_master_translator_avalon_universal_master_0_address;              // nios2e_data_master_translator:uav_address -> nios2e_data_master_agent:av_address
	...
	wire  [91:0] rsp_mux_src_data;                                                             // rsp_mux:src_data -> nios2e_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                            // nios2e_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [4:0] rsp_mux_src_channel;                                                          // rsp_mux:src_channel -> nios2e_data_master_agent:rp_channel
	...
	wire  [15:0] nios2e_instruction_master_translator_avalon_universal_master_0_address;       // nios2e_instruction_master_translator:uav_address -> nios2e_instruction_master_agent:av_address
	...
	wire  [91:0] rsp_mux_001_src_data;                                                         // rsp_mux_001:src_data -> nios2e_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                        // nios2e_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [4:0] rsp_mux_001_src_channel;                                                      // rsp_mux_001:src_channel -> nios2e_instruction_master_agent:rp_channel
	...
	wire  [15:0] nios2e_debug_mem_slave_agent_m0_address;                                      // nios2e_debug_mem_slave_agent:m0_address -> nios2e_debug_mem_slave_translator:uav_address
	...
	wire  [92:0] nios2e_debug_mem_slave_agent_rf_source_data;                                  // nios2e_debug_mem_slave_agent:rf_source_data -> nios2e_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [92:0] nios2e_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2e_debug_mem_slave_agent_rsp_fifo:out_data -> nios2e_debug_mem_slave_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_001_src_data;                                                         // cmd_mux_001:src_data -> nios2e_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                        // nios2e_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                      // cmd_mux_001:src_channel -> nios2e_debug_mem_slave_agent:cp_channel
	...
	wire  [15:0] pb_s1_agent_m0_address;                                                       // pb_s1_agent:m0_address -> pb_s1_translator:uav_address
	...
	wire  [92:0] pb_s1_agent_rf_source_data;                                                   // pb_s1_agent:rf_source_data -> pb_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] pb_s1_agent_rsp_fifo_out_data;                                                // pb_s1_agent_rsp_fifo:out_data -> pb_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                        // cmd_mux_003:src_valid -> pb_s1_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                         // cmd_mux_003:src_data -> pb_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                        // pb_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                      // cmd_mux_003:src_channel -> pb_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                // cmd_mux_003:src_startofpacket -> pb_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                  // cmd_mux_003:src_endofpacket -> pb_s1_agent:cp_endofpacket
	...
	wire  [91:0] nios2e_data_master_agent_cp_data;                                             // nios2e_data_master_agent:cp_data -> router:sink_data
	...
	wire  [91:0] nios2e_instruction_master_agent_cp_data;                                      // nios2e_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [91:0] nios2e_debug_mem_slave_agent_rp_data;                                         // nios2e_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire         pb_s1_agent_rp_valid;                                                         // pb_s1_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] pb_s1_agent_rp_data;                                                          // pb_s1_agent:rp_data -> router_005:sink_data
	wire         pb_s1_agent_rp_ready;                                                         // router_005:sink_ready -> pb_s1_agent:rp_ready
	wire         pb_s1_agent_rp_startofpacket;                                                 // pb_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         pb_s1_agent_rp_endofpacket;                                                   // pb_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         pb_s1_agent_rdata_fifo_src_valid;                                             // pb_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pb_s1_agent_rdata_fifo_src_data;                                              // pb_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pb_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_003:in_0_ready -> pb_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                            // avalon_st_adapter_003:out_0_valid -> pb_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                             // avalon_st_adapter_003:out_0_data -> pb_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                            // pb_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                            // avalon_st_adapter_003:out_0_error -> pb_s1_agent:rdata_fifo_sink_error
	...
	nios_setup_mm_interconnect_0_router_001 router_001 (
	...
	nios_setup_mm_interconnect_0_router_003 router_003 (
	...
	nios_setup_mm_interconnect_0_router_003 router_004 (
	...
	nios_setup_mm_interconnect_0_router_002 router_006 (
	...
	nios_setup_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (nios2e_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_setup_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (nios2e_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_setup_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (nios2e_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_setup_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (nios2e_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_setup_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (nios2e_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_setup_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (nios2e_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_setup_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (nios2e_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_setup_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (nios2e_reset_reset_bridge_in_reset_reset), // clk_reset.reset
